...
New release gates must be added to the launcher mapping and the maintained GPU
acceptance matrix. Do not create an unindexed look-alike YAML and infer its
maturity from the filename alone.
